  ...
  useEffect(() => {
    if (window.innerWidth <= 576 && targetRef?.current) {
      ...
      if (visiblePercentage > 14) {
        ...
        const width =
          part1RefBlue.current.children[0].offsetLeft +
          part1RefBlue.current.children[0].offsetWidth;
      ...
      if (visiblePercentage > 16) {
        const maxWidth =
          part1Ref.current.children[0].offsetLeft +
          part1Ref.current.children[0].offsetWidth +
          part1Ref.current.children[1].offsetWidth +
          part1Ref.current.children[2].offsetWidth;
        const width =
          (maxWidth * (visiblePercentage - 16) * 5.55) / 100 +
          part1Ref.current.children[0].offsetLeft +
          part1Ref.current.children[0].offsetWidth;
      ...
      if (visiblePercentage > 21) {
        const maxWidth =
          ...
          part1Ref.current.children[1].offsetWidth;
        const width =
          (maxWidth * (visiblePercentage - 21) * 5.88) / 100 +
          part1Ref.current.children[0].offsetLeft +
          part1Ref.current.children[0].offsetWidth;
        const px = width > maxWidth ? maxWidth : width;
      ...
      if (visiblePercentage > 37) {
        ...
        const width =
          (maxWidth * (visiblePercentage - 37) * 5.55) / 100 +
          part1Ref.current.children[0].offsetLeft +
          part1Ref.current.children[0].offsetWidth +
          part1Ref.current.children[1].offsetWidth +
          part1Ref.current.children[2].offsetWidth;
      ...
      if (visiblePercentage > 40) {
        const maxWidth = targetRef.current.offsetWidth;
        const width =
          (maxWidth * (visiblePercentage - 40) * 5.55) / 100 +
          part1Ref.current.children[0].offsetLeft +
          part1Ref.current.children[0].offsetWidth +
          part1Ref.current.children[1].offsetWidth +
          part1Ref.current.children[2].offsetWidth;
      ...
      if (visiblePercentage > 46) {
        const height =
          (part2Ref.current.children[0].offsetHeight *
            ((visiblePercentage - 46) * 8 > 100
              ? 100
              : (visiblePercentage - 46) * 8)) /
          100;
        part2Ref.current.style.height = `${height}px`;
        part2Ref.current.style.marginBottom = `${
          part2Ref.current.children[0].offsetHeight - height
        }px`;
      } else {
      ...
      if (visiblePercentage > 50) {
        blueHeight =
          (part2RefBlue.current.children[0].offsetHeight *
            ((visiblePercentage - 50) * 10 > 100
              ? 100
              : (visiblePercentage - 50) * 10)) /
          100;
        part2RefBlue.current.style.height = `${blueHeight}px`;
        part2RefBlue.current.style.marginBottom = `${
          part2RefBlue.current.children[0].offsetHeight - blueHeight
        }px`;
      } else {
      ...
      if (visiblePercentage > 59) {
        ...
        const width =
          (targetRef.current.offsetWidth * (visiblePercentage - 59) * 5.55) /
          100;
      ...
      if (visiblePercentage > 61) {
        const maxWidth =
          part3RefBlue.current.children[5].offsetWidth +
          part3RefBlue.current.children[6].offsetWidth;
        const width =
          (targetRef.current.offsetWidth * (visiblePercentage - 61) * 5.55) /
          100;
        const realWidth = width > maxWidth ? maxWidth : width;
        part3RefBlue.current.style.width = `${realWidth}px`;
        part3RefBlue.current.scrollLeft =
          targetRef.current.offsetWidth - realWidth;
      } else {
      ...
      if (visiblePercentage > 65) {
        ...
        const realWidth =
          part3RefBlue.current.children[5].offsetWidth +
          part3RefBlue.current.children[6].offsetWidth +
          part3RefBlue.current.children[4].offsetWidth;
        part3RefBlue.current.style.width = `${realWidth}px`;
        part3RefBlue.current.scrollLeft =
          targetRef.current.offsetWidth - realWidth;
      } else {
      ...
      if (visiblePercentage > 67) {
        ...
        const width =
          (targetRef.current.offsetWidth * (visiblePercentage - 67) * 5.55) /
            100 +
          part3Ref.current.children[5].offsetWidth +
          part3Ref.current.children[6].offsetWidth +
          part3Ref.current.children[4].offsetWidth;
      ...
      if (visiblePercentage > 70) {
        const maxWidth =
          ...
          part3RefBlue.current.children[6].offsetWidth +
          part3RefBlue.current.children[4].offsetWidth +
          part3RefBlue.current.children[3].offsetWidth;
        const width =
          (targetRef.current.offsetWidth * (visiblePercentage - 70) * 7.55) /
            100 +
          part3RefBlue.current.children[5].offsetWidth +
          part3RefBlue.current.children[6].offsetWidth +
          part3RefBlue.current.children[4].offsetWidth;
      ...
      if (visiblePercentage > 74.5) {
        ...
        const realWidth =
          ...
          part3RefBlue.current.children[6].offsetWidth +
          part3RefBlue.current.children[3].offsetWidth +
          part3RefBlue.current.children[2].offsetWidth +
          part3RefBlue.current.children[4].offsetWidth;
        part3RefBlue.current.style.width = `${realWidth}px`;
        part3RefBlue.current.scrollLeft =
          targetRef.current.offsetWidth - realWidth;
      ...
      if (visiblePercentage > 79) {
        const maxWidth = targetRef.current.offsetWidth;
        const width =
          (targetRef.current.offsetWidth * (visiblePercentage - 79) * 5.55) /
            100 +
          part3RefBlue.current.children[5].offsetWidth +
          part3RefBlue.current.children[6].offsetWidth +
          part3RefBlue.current.children[4].offsetWidth +
      ...
      if (visiblePercentage > 88) {
        const blueHeight =
          (part4RefBlue.current.children[0].offsetHeight *
            ((visiblePercentage - 88) * 5 > 100
              ? 100
              : (visiblePercentage - 88) * 5)) /
          100;
      ...
      if (visiblePercentage > 119) {
        ...
        part5RefBlue.current.style.width = `${
          part5RefBlue.current.children[0].offsetWidth +
          part5RefBlue.current.children[1].offsetWidth +
